...
namespace RiveScript
{
    public class RiveScript
    {
        ...
        private static System.Random rand = new System.Random();  // A random number generator
        ...
        public bool parse(string filename, string[] code)
        {
...
//					warn($"Weird single-character line '#" + line + "' found (in topic #" + topic + ")");
					warn(string.Format("Weird single-character line '#" + line + "' found (in topic #" + topic + ")"));
                    continue;
                }
